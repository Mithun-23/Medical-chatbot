...
PROMPT_TEMPLATE = """
Your name is Dr.Chat - an AI mental health companion providing empathetic, evidence-based emotional support.

=== IN-APP ACTIONS ===
Include ONE action tag when appropriate:

GAMES (for distraction/stress relief):
- [ACTION:GAME:puzzle] - Focus-building puzzle game
- [ACTION:GAME:adventure] - Escape/adventure game  
- [ACTION:GAME:relaxing] - Calming nature game

MUSIC (for relaxation):
- [ACTION:MUSIC] - Open calming music player

EMERGENCY (ONLY for self-harm/suicide/immediate danger):
- [ACTION:EMERGENCY] - Show crisis helplines

BREATHING (for anxiety/panic):
- [ACTION:BREATHING] - Start breathing exercise

JOURNAL (for processing emotions):
- [ACTION:JOURNAL:Write about what made you feel this way] - Journaling prompt

=== RESPONSE GUIDELINES ===
- Be SHORT (2-4 sentences max)
- Be empathetic and validating
- Use action tags when helpful, not every message
- For crisis: Use [ACTION:EMERGENCY] and express care
...
#     domain="apparent-wolf-obviously.ngrok-free.app",
# )
...
#         valid_messages = [
#             msg["text"] for msg in messages if isinstance(msg, dict) and "text" in msg
#         ]
...
#             if last_message and len(last_message.split(".")) > 1
#             else last_message
#         )
...
#         if "label" not in result or result["label"] not in [
#             "positive",
#             "negative",
#             "neutral",
#         ]:
...
#             avg_percentage = (
#                 round(total_percentage / len(message_analyses))
#                 if message_analyses
#                 else 50
#             )
#             overall_sentiment = (
...
#                 else "negative" if avg_percentage < 40 else "neutral"
#             )
...
#                 "positive": (
#                     round((sentiment_counts["positive"] / len(message_analyses)) * 100)
#                     if message_analyses
#                     else 0
#                 ),
#                 "negative": (
#                     round((sentiment_counts["negative"] / len(message_analyses)) * 100)
#                     if message_analyses
#                     else 0
#                 ),
#                 "neutral": (
#                     round((sentiment_counts["neutral"] / len(message_analyses)) * 100)
#                     if message_analyses
#                     else 0
#                 ),
#             },
...
#             "sentiment_distribution_percentage": {
#                 "positive": (
#                     round((sentiment_counts["positive"] / len(prompts)) * 100)
#                     if prompts
#                     else 0
#                 ),
#                 "negative": (
#                     round((sentiment_counts["negative"] / len(prompts)) * 100)
#                     if prompts
#                     else 0
#                 ),
#                 "neutral": (
#                     round((sentiment_counts["neutral"] / len(prompts)) * 100)
#                     if prompts
#                     else 0
#                 ),
#             },
...
#         if not reports:
#             return (
#                 jsonify({"message": "No sentiment reports found for this session"}),
#                 404,
#             )
